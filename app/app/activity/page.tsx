    ...
    <PageContainer className="max-w-[760px]">
      ...
      {!activities || activities.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-muted-foreground">
          <Activity variant="Bulk" size={40} className="mb-3 opacity-40" />
        ...
        <ol className="relative ml-3 border-l border-border">
          {activities.map((item: any) => (
            <li key={item._id} className="mb-6 ml-6">
              <span className="absolute -left-3 flex h-6 w-6 items-center justify-center rounded-full bg-card border border-border text-sm">
